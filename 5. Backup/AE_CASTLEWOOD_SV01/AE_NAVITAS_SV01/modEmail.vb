...
Module modEmail
    ...
    Public Sub EmailTemplate_Error()
        ...
        Try
            ...
            sBody = sBody & " Dear Valued Customer,<br /><br /> Castle wood Interface program had encountered the problem based on the following information. <br /><br />"
    ...
    Public Sub EmailTemplate_Success()
        ...
        Try
            ...
            sBody = sBody & "<div align=left style='font-size:10.0pt;font-family:Arial'>"
            sBody = sBody & " Dear Valued Customer,<br /><br /> Castle wood Interface program had Successfully uploaded the files into SAP. <br /><br />"
            ...
            sBody = sBody & "<tr><td><strong style='color: blue; background-color: transparent;'>&nbsp;No&nbsp;</strong></td> "
            sBody = sBody & "<td><strong style='color: blue; background-color: transparent;'>&nbsp;File Name&nbsp;</strong></td> "
            sBody = sBody & "<td><strong style='color: blue; background-color: transparent;'>&nbsp;Trans ID&nbsp;</strong></td> "
            ...
            For i As Integer = 1 To p_oDtSuccess.Rows.Count
                ...
                'Status
                sBody = sBody & "<td>&nbsp;" & p_oDtSuccess.Rows(i - 1).Item(2).ToString & "&nbsp;</td>"
                sBody = sBody & "</tr>"
            Next
    ...
    Public Sub EmailTemplate_GeneralError(ByVal sErrDesc As String, ByRef sErr As String)
        Dim sFuncName As String = String.Empty
        Dim sMessage As String = String.Empty
        Dim sBody As String = String.Empty
